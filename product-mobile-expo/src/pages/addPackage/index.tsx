...
const AddPackage = () => {
    ...
    const [ styleInputTracker, setStyleInputTracker ] = useState();
    const [ styleInputDesc, setStyleInputDesc ] = useState();
    ...
    useEffect(() => {
      ...
      const handelsavePackage = async () => {
        ...
        await api.post('packages', {trackerNumber: userTrackerNumber,
